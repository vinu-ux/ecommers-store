(function(window, document, $, undefined) {
    ...
    var hostnyxInit = {
        ...
        methods: function(e) {
            hostnyxInit.w();
            hostnyxInit.contactForm();
            hostnyxInit.hostnyxBackToTop();
            hostnyxInit.stickyHeaderMenu();
            hostnyxInit.mobileMenuActivation();
            hostnyxInit.salActivation();
            hostnyxInit.hostnyxMasonary();
            hostnyxInit.counterUp();
            hostnyxInit.hostnyxSlickActivation();
            hostnyxInit.magnificPopupActivation();
            hostnyxInit.countdownInit('.countdown', '2022/08/26');
            hostnyxInit.tiltAnimation();
            hostnyxInit.menuLinkActive();
            hostnyxInit.audioPlayerActivation();
            hostnyxInit.onePageNav();
            hostnyxInit.pricingPlan();
            hostnyxInit.marqueImages();
            hostnyxInit.hostnyxHover();
            hostnyxInit.onePageTopFixed();
            hostnyxInit.blogModalActivation();
            hostnyxInit.portfolioModalActivation();
            hostnyxInit.caseModalActivation();
            hostnyxInit.themeColorSet();
           
        },

        w: function(e) {
            this._window.on('load', hostnyxInit.l).on('scroll', hostnyxInit.res)
        },

        contactForm: function() {
            $('.hostnyx-contact-form').on('submit', function(e) {
                e.preventDefault();
                var _self = $(this);
        ...
        stickyHeaderMenu: function() {
            ...
            $(window).on('scroll', function() {
                ...
                if ($('body').hasClass('sticky-header')) {
                    var stickyPlaceHolder = $('#hostnyx-sticky-placeholder'),
                        menu = $('.hostnyx-mainmenu'),
                        menuH = menu.outerHeight(),
                        topHeaderH = $('.hostnyx-header-top').outerHeight() || 0,
                        targrtScroll = topHeaderH + 200;
                    if ($(window).scrollTop() > targrtScroll) {
                        menu.addClass('hostnyx-sticky');
                        stickyPlaceHolder.height(menuH);
                    } else {
                        menu.removeClass('hostnyx-sticky');
        ...
        mobileMenuActivation: function(e) {
            ...
            $('.menu-item-has-children > a').on('click', function(e) {
                ...
                var targetParent = $(this).parents('.mainmenu-nav'),
                    target = $(this).siblings('.hostnyx-submenu'),
                    targetSiblings = $(this).parent('.menu-item-has-children').siblings().find('.hostnyx-submenu');
            ...
            function resizeClassAdd() {
                if (window.matchMedia('(min-width: 992px)').matches) {
                    ...
                    $('.hostnyx-mainmenu .offcanvas-backdrop').remove();
                    $('.hostnyx-submenu').removeAttr('style');
                } else {
        ...
        hostnyxMasonary: function () {
            $('.hostnyx-isotope-wrapper').imagesLoaded(function () {
        ...
        hostnyxSlickActivation: function(e) {
            $('.slick-slider').slick();
        },
        ...
        caseModalActivation : function () {
            ...
            if ($('body').hasClass('onepage-template')) {
                ...
                caseList.each(function() {
                    ...
                    var $this = $(this);
                    var buttons = $this.find('.hostnyx-btn');
                    var title = $this.find('.title');
